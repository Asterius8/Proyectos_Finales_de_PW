...
public class ActivityHubTutor extends AppCompatActivity {
    ...
    public void abrirCambiosReporte(View v){//Metodo para abrir la ActivityAltas

        Intent i = new Intent(this, ActivityCambiosReporte.class);
        startActivity(i);

    }

    public void abrirConsultarReporte(View v){//Metodo para abrir la ActivityAltas

        Intent i = new Intent(this, ActivityConsultasReporte.class);
        startActivity(i);
